        ...
        <div class="row">
            <div class="col-12 card px-3">
                <div class="row px-4 pb-3">
                    <div class="col-12 table-title p-2 px-3" style="background-color: rgba(168, 255, 236, 0.64); color: black;">
                        <div class="row">
                            ...
                            ?>
                            <div style="text-align: center;" class="my-auto col-4 d-none d-lg-block">Active Categories: <?= $active ?></div>
                            <div style="text-align: center;" class="my-auto col-4 d-none d-lg-block">Rejected Categories: <?= $deactive ?></div>
                ...
                <table class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $resultset = Database::search("SELECT * FROM `category` WHERE `id`!='0' ORDER BY `name` ");
