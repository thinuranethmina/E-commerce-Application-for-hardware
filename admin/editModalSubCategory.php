...
if (isset($_SESSION['admin_email'])) {
    ...
    $statusrs = Database::search("SELECT * FROM `sub_category` WHERE `id`='" . $_GET["id"] . "';");
...
?>
        ...
        <div class="col-12 p-4" style="text-align: right;">
            ...
            <button type="button" class="btn btn-primary" onclick="saveChangeSubCategory('<?= $user['id'] ?>');">Save</button>
        </div>
<?php
    }
} else {
