        ...
        <div class="row px-4">
            <div class="col-12 card px-3">
                ...
                <table class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $resultset = Database::search("SELECT * FROM `category` WHERE `id`!='0' AND `status_id`='1' ORDER BY `name` ");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="container">
                                            <input id="toggleStatus<?= $row['id'] ?>" type="checkbox" onclick="changeStatusCategory('<?= $row['id'] ?>');" checked>
