        ...
        <div class="row px-4">
            <div class="col-12 card px-3">
                ...
                <table class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $resultset = Database::search("SELECT `sub_category`.`id`, `sub_category`.`name`, `category`.`name` AS `categoryName`, `sub_category`.`status_id` FROM `sub_category` INNER JOIN `category` ON `category`.`id` = `sub_category`.`category_id` WHERE `sub_category`.`id`!='0' AND `sub_category`.`status_id`='0' ORDER BY `category_id` ");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="container">
                                            <input id="toggleStatus<?= $row['id'] ?>" type="checkbox" onclick="changeStatusSubCategory2('<?= $row['id'] ?>');">
